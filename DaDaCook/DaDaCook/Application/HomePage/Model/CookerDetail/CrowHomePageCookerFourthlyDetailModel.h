//
//  CrowHomePageCookerFourthlyDetailModel.h
//  DaDaCook
//
...
@property (nonatomic, strong) CrowHomePageCookerFourthlyDetailDataModel *data;
@property (nonatomic, assign) NSInteger code;

@end


@interface CrowHomePageCookerFourthlyDetailDataModel : NSObject

@property (nonatomic, assign) NSInteger cnt_avg;
@property (nonatomic, strong) NSArray<CrowHomePageCookerFourthlyDetailDataListModel *> *list;
...
@interface CrowHomePageCookerFourthlyDetailDataListModel : NSObject

@property (nonatomic, assign) NSInteger image_cnt;
@property (nonatomic, copy  ) NSString  *content;
// order_tag -> order
@property (nonatomic, strong) NSArray<CrowHomePageCookerFourthlyDetailDataListOrderModel *> *order;
...
@interface CrowHomePageCookerFourthlyDetailDataListPraiseModel : NSObject
...
@interface CrowHomePageCookerFourthlyDetailDataListOrderModel : NSObject
...
@interface CrowHomePageCookerFourthlyDetailDataListExpressModel : NSObject
