//
//  CrowHomePageCookerFirstDetailModel.h
//  DaDaCook
//
...
@class CrowHomePageCookerFirstDetailDataModel,CrowHomePageCookerFirstDetailDataInfoModel,CrowHomePageCookerFirstDetailDataMsgModel;

@interface CrowHomePageCookerFirstDetailModel : NSObject

@property (nonatomic, copy  ) NSString  *msg;
@property (nonatomic, strong) CrowHomePageCookerFirstDetailDataModel *data;
@property (nonatomic, assign) NSInteger code;

@end


@interface CrowHomePageCookerFirstDetailDataModel : NSObject
...
// busy_info -> info
@property (nonatomic, strong) CrowHomePageCookerFirstDetailDataInfoModel *info;
...
// auth_msg_list -> msg
@property (nonatomic, strong) NSArray<CrowHomePageCookerFirstDetailDataMsgModel *> *msg;
...
@interface CrowHomePageCookerFirstDetailDataInfoModel : NSObject
...
@interface CrowHomePageCookerFirstDetailDataMsgModel : NSObject
