...
@class CrowHomePageCookerDataModel,CrowHomePageCookerDataPrelocateModel,CrowHomePageCookerDataListModel,CrowHomePageCookerDataListDetailModel;

@interface CrowHomePageCookerModel : NSObject

@property (nonatomic, copy  ) NSString                    *msg;
@property (nonatomic, strong) CrowHomePageCookerDataModel *data;
@property (nonatomic, assign) NSInteger                   code;

@end


@interface CrowHomePageCookerDataModel : NSObject

@property (nonatomic, assign) NSInteger count;
@property (nonatomic, assign) NSInteger size;
@property (nonatomic, strong) NSArray   *promotion_list;
@property (nonatomic, strong) CrowHomePageCookerDataPrelocateModel *prelocate;
@property (nonatomic, strong) NSArray<CrowHomePageCookerDataListModel *> *list;
...
@interface CrowHomePageCookerDataPrelocateModel : NSObject
...
@interface CrowHomePageCookerDataListModel : NSObject
...
// recommend_dishes_detail -> detail
@property (nonatomic, strong) NSArray<CrowHomePageCookerDataListDetailModel *> *detail;
...
@interface CrowHomePageCookerDataListDetailModel : NSObject
